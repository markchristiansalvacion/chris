...
<head>
  ...
  <title>Add Employee - CHRIS</title>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <li>
            <a href="admin_manage_employee.php">
              <i class="bi bi-circle"></i><span>Manage Employee</span>
            </a>
          </li>
          <li>
            <a href="admin_add_employee.php" class="active">
      ...
      <li class="nav-item">
        ...
        <i class="bi bi-calculator"></i></i><span>Payroll</span><i class="bi bi-chevron-down ms-auto"></i>
        </a> -->
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="admin_manage_payroll.php">
              <i class="bi bi-circle"></i><span>Manage Payroll</span>
            </a>
          </li>
        </ul>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="form-floating mb-3">
                      ...
                      <label for="floatingInput">Philhealth</label>
                    </div>
                    <div class="form-floating mb-3">
                      <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com">
                      <label for="floatingInput">Pagibig</label>
                    </div>
                    <div class="form-floating mb-3">
                      <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com">
