    ...
    <pre><?php
            ...
            ?></pre><?php
                ...
                */
                ...
                {
                    $inbound_lpn = $db->query('SELECT id,lpn,bin_location,batch_no,item_code,qty_pcs FROM tb_inbound where lpn=?', $lpn)->fetch_all();
                ...
                function get_bet_bin_loc($db, $bin_loc)
                {
                    ...
                    $all_aisle_location = $db->query('SELECT * FROM tb_bin_location_bac WHERE aisle = ? ORDER BY location_code ASC', $bin_loc)->fetch_all();
